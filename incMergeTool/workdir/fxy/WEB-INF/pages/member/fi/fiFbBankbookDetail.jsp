...
<head>
    <title><fmt:message key="FB账户流水"/></title>
    <meta name="heading" content="<fmt:message key="FB账户流水"/>"/>
</head>

<c:set var="moneykey" value="结余个数"/>
<c:set var="moneytitle" value="您的账户当前个数余额有"/>
<c:set var="moneytitle2" value="mem.fi.dongjie"/>

<br/>
<form method="get" action="fiFbBankbookDetail.jhtml" onsubmit="return validateSearch(this)">
	...
	<input type="hidden" name="strAction" value="memberFbBankbookDetail"/>
</form>
...
<%-- <win:page pageId="fiBankbookJournalListPager" action="fiFbBankbookDetail.jhtml" autoIncludeParameters="true"/> --%>
