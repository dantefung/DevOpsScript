...
<form:form commandName="fiAcTrans" method="post" action="editFiAcTransA1A2ToOther.jhtml" onsubmit="return validateForm(this)" id="sysUserForm">
        ...
        <table class="detail">
            <tr>
                <td class="title" colspan="2" style="font-weight: normal;">
                    ...
                    <br/><b><fmt:message key="接收会员"/></b><fmt:message key="须与你处于"/><b><fmt:message key="同一网络"/></b>；
                </td>
            </tr>
            <tr>
                <th>&nbsp;</th>
