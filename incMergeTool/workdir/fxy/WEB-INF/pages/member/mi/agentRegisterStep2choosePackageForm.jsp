...
<form method="get" action="agentRegisterStep2choosePackage.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="agentRegisterStep2choosePackage.jhtml">
 <input type="hidden" id="newAgentRegisterKey" name="newAgentRegisterKey" value="${newAgentRegisterKey}"/>
		...
		<tbody>
			<c:forEach items="${requestScope[pmProducts]}" var="pmProductVar">
				...
				<tr>
					...
					<td align="right"><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.turnover_price }"/></td>
					<td align="center">
						...
						<input type="hidden" name="${pmProductVar.product_code }_unitPrice${i}" id="${pmProductVar.product_code }_unitPrice${i}" value="${pmProductVar.turnover_price }"/>
						<input type="hidden" name="${pmProductVar.product_code }_unitPv${i}" id="${pmProductVar.product_code }_unitPv${i}" value="0"/> 
	...
	<tr>
   		<td colspan="2">
   			<div class="buttonBar">
   				...
   				<input type="hidden" id="newAgentRegisterKey" name="newAgentRegisterKey" value="${newAgentRegisterKey}"/>
   				<button type="button" class="btn btn-default" name="previous" onclick="window.location='agentRegisterStep2chooseProduct.jhtml?newAgentRegisterKey=${newAgentRegisterKey }'"><fmt:message key="button.previous"/></button>
