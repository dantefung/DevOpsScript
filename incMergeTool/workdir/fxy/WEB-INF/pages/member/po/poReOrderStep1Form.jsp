...
<form:form commandName="miMember" method="post" action="poReOrderStep1.jhtml"  name="miMemberForm" id="miMemberForm" cssClass="form-horizontal" onsubmit="return validateForm(this);">
