...
<form:form commandName="poShip" method="post" action="poReOrderStep2.jhtml" onsubmit="return validateForm(this)" name="poShipForm" id="poShipForm" cssClass="form-horizontal">
		...
		<div class="col-md-7">
			...
			<div class="form-group form-group-sm">
				<div class="col-sm-12 text-center">
					...
					<button type="button" class="btn btn-default" name="previous" onclick="window.location='poReOrderStep1.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>    				
