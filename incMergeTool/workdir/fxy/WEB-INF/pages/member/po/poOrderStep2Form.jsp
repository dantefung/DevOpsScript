...
<form method="get" action="poOrderStep2.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="poOrderStep2.jhtml">
		...
		<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poOrderStep1.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
