...
<form method="get" action="poExchangeOrderStep3.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="poExchangeOrderStep3.jhtml">
		...
		<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poExchangeOrderStep2.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
