...
<form id="pmProductListTableForm" method="post" action="poReOrderStep4.jhtml">
	...
	<tr>
   		<td colspan="2">
   			<div class="buttonBar">
   				...
   				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poReOrderStep3.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
