...
<form:form commandName="poShip" method="post" action="poAgentOrderStep2.jhtml" onsubmit="return validateForm(this)" name="poShipForm" id="poShipForm">
    	...
    	<tr>
    		<td colspan="2">
    			<div class="buttonBar">
					...
					<button type="button" class="btn btn-default" name="previous" onclick="window.location='poAgentOrderStep1.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>    				
