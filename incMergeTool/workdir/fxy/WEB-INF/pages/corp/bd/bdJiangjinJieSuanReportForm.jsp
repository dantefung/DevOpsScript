...
<head>
    <title><fmt:message key="title.bdJiangjinJieSuanReport"/></title>
    <meta name="heading" content="<fmt:message key="title.bdJiangjinJieSuanReport"/>"/>
</head>

<div class="contentBody">
    <form:form commandName="bdBonusSub" method="post" action="bdJiangjinJieSuanReport.jhtml" onsubmit="return validateForm(this)" id="bdJiangjinJieSuanReportForm">
