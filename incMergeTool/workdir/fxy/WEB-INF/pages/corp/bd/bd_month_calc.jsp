...
<head>
    <title><fmt:message key="serviceName.BdMonthCalc"/></title>
    <meta name="heading" content="<fmt:message key="serviceName.BdMonthCalc"/>"/>
</head>

<div class="contentBody">
    <form:form commandName="bdMonthStatus" method="post" action="bdMonthCalc.jhtml" onsubmit="return validateForm(this)" id="bdBonusSubForm">
    	...
    	<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<input type="hidden" name="strAction" value="bdMonthCalc"/>
