...
<div class="contentBody">
    <fmt:message key="mi.askFor.no"/>：<b>${param.uniqueNo }</b><br/>
	...
	<form id="miCardChangeFileListTableForm" method="get" >
		<ec:table 
			...
			rowsDisplayed="20" sortable="false" form="miCardChangeFileListTableForm" showPagination="false">
			<ec:row>
				<ec:column property="fileName" title="mi.lable.file.explain">
					<img src="${ctx}/themes/${theme }/images/attach/${miCardChangeFileVar.suffixName}.gif" border="0" width="16" height="16"/>
					<a href="<c:url value="${miCardChangeFileVar.fileUrl}"/>" target="_blank">${miCardChangeFileVar.fileName }</a>
				</ec:column>
				...
				<ec:column property="fileSize" title="mi.lable.file.size" styleClass="numberColumn">
					<fmt:formatNumber pattern="###,##0">${miCardChangeFileVar.fileSize}</fmt:formatNumber>
				</ec:column>
	...
	<br/><br/>
    <form:form commandName="miCardChangeFile" method="post" action="editMiCardChangeFile.jhtml" onsubmit="return validateForm(this)" id="miCardChangeFileForm" enctype="multipart/form-data">
    <spring:bind path="miCardChangeFile.*">
	    	...
	    	<tr>
	    		<td colspan="2">
	    			<div class="buttonBar">
	    				...
	    				<input type="hidden" name="strAction" value="addMiCardChangeFile"/>
