...
<div class="contentBody">
	...
	<form id="miStateFileListTableForm" method="get" >
		<ec:table 
			...
			rowsDisplayed="20" sortable="false" form="miStateFileListTableForm" showPagination="false">
			<ec:row>
				<ec:column property="fileName" title="mi.lable.file.explain">
					...
					<a href="<c:url value="${miStateFileVar.fileUrl}"/>" target="_blank">${miStateFileVar.fileName }</a>
				</ec:column>
				...
				<ec:column property="fileSize" title="mi.lable.file.size" styleClass="numberColumn">
					<fmt:formatNumber pattern="###,##0">${miStateFileVar.fileSize}</fmt:formatNumber>
				</ec:column>
	...
	<br/><br/>
    <form:form commandName="miStateFile" method="post" action="editMiStateFile.jhtml" onsubmit="return validateForm(this)" id="miStateFileForm" enctype="multipart/form-data">
    
    <spring:bind path="miStateFile.*">
    ...
    <table class="detail" id="_table">
    	<tr>
    		<td  class="title"><fmt:message key="mi.add.file"/></td>
    	...
    	<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<input type="hidden" name="strAction" value="addMiStateFile"/>
