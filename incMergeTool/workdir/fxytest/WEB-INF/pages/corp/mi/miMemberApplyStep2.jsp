...
<div class="contentBody">
    <form:form commandName="miMemberApply" method="post" action="miMemberApplyStep2.jhtml" id="miMemberApplyForm">
	    ...
	    <table class="detail">
	    	...
	    	<win:power powerCode="editMiMemberBasic">
		    	...
		    	<tr>
		    		...
		    		<td><input type="text" name="marketName" id="marketName" value="${miMember.marketName}"/></td>
		    	</tr>
		    	<tr>
		    	...
		    	<tr>
		    		<th valign="top" class="required"><fmt:message key="miMember.delivery.addr"/>:</th>
		    		<td>
	    	...
	    	<tr>
	    		<td colspan="2">
	    			<div class="buttonBar">
	    				...
	    				<button type="button"  name="previous" onclick="window.location='miMemberApplyStep1.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
