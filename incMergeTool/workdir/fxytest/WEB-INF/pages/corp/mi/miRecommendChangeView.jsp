...
<head>
    <title><fmt:message key="mi.recommend.view.title"/></title>
    <meta name="heading" content="<fmt:message key="mi.recommend.view.title"/>"/>
</head>
<%
request.setAttribute("vEnter", "\n");
%>
<div class="contentBody">
    <form:form commandName="miMemberApply" method="post" action="viewMiRecommendChange.jhtml" id="miMemberApplyForm" onsubmit="return validateForm(this)">
    ...
    <table class="detail" width="90%">
	   ...
	   <c:if test="${not empty miMemberApplyDetailMap.MI_MEMBER ||  not empty miMemberApplyDetailMap.SYS_USER_ROLE }">
	    	<tr>
