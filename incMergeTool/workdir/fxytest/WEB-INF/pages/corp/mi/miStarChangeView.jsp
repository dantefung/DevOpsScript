...
<head>
    <title><fmt:message key="mi.star.view.title"/></title>
    <meta name="heading" content="<fmt:message key="mi.star.view.title"/>"/>
</head>
<%
request.setAttribute("vEnter", "\n");
%>
<div class="contentBody">
    <form:form commandName="miMemberApply" method="post" action="viewMiStarChange.jhtml" id="miMemberApplyForm" onsubmit="return validateForm(this)">
