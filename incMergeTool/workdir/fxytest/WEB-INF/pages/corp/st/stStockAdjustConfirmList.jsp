...
<head>
    <title><fmt:message key="库存调整 - 确认"/></title>
    <meta name="heading" content="<fmt:message key="库存调整 - 确认"/>"/>
</head>
...
<div class="searchBar">
	<form method="get" action="stStockAdjustConfirm.jhtml" onsubmit="return validateSearch(this)">
		...
		<dl>
			<dt>审核时间</dt>
			<dd>
				<input type="hidden" name="dateRangeType" value="checkTime"/>
		...
		<dl>
			...
			<dd>
				...
				<input type="hidden" name="strAction" value="stStockAdjustConfirm"/>
			</dd>
		</dl>
	</form>
</div>
...
<div class="contentBody">
	<form name="stStockAdjustFunctionForm" id="stStockAdjustFunctionForm" action="editStStockAdjust.jhtml" method="post" >
		...
		<div class="functionBar">
			<win:power powerCode="confirmStStockAdjust">
				<a href="javascript:multiConfirmStStockAdjust()" name="check">
					确认
				</a>
			</win:power>
		</div>
	...
	<form id="stStockAdjustListTableForm" method="get" >
		<ec:table 
			...
			action="stStockAdjustConfirm.jhtml"
