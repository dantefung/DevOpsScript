...
<div class="contentBody">
    <form:form commandName="poShip" method="post" action="poOrderMaintUStep2.jhtml" onsubmit="return validateForm(this)" name="poShipForm" id="poShipForm">
    ...
    <table class="detail">
    	...
    	<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				<input type="hidden" id="strAction" name="strAction" value="poOrderMaintU"/>
    				<input type="hidden" value="${form.token}" name="_form_uniq_id" />
    				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poOrderMaintUStep1.jhtml?strAction=poOrderMaintU'"><fmt:message key="button.previous"/></button>
