...
<head>
    <title><fmt:message key="menu.pm.searchPmPersonLimitAdjusts"/></title>
    <meta name="heading" content="<fmt:message key="menu.pm.searchPmPersonLimitAdjusts"/>"/>
</head>
...
<div class="searchBar">
	<form method="get" action="searchPmPersonLimitAdjusts.jhtml" onsubmit="return validateSearch(this)">
		...
		<dl>
			...
			<dd>
				...
				<input type="hidden" name="strAction" value="searchPmPersonLimitAdjusts"/>
			</dd>
		</dl>
	</form>
</div>
...
<div class="contentBody">
	<form id="pmPersonLimitAdjustListTableForm" method="get" >
		<ec:table 
			...
			action="searchPmPersonLimitAdjusts.jhtml"
