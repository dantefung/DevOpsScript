...
<head>
    <title><fmt:message key="serviceName.BdMonthConfirm"/></title>
    <meta name="heading" content="<fmt:message key="serviceName.BdMonthConfirm"/>"/>
</head>

<div class="contentBody">
    <form:form commandName="bdMonthStatus" method="post" action="bdMonthConfirm.jhtml" onsubmit="return validateForm(this)" id="bdBonusSubForm">
    	...
    	<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<input type="hidden" name="strAction" value="bdMonthConfirm"/>
