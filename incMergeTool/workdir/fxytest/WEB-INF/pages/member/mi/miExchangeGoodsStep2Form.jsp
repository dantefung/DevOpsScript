...
<form:form commandName="poShip" method="post" action="miExchangeGoodsStep2.jhtml" onsubmit="return validateForm(this)" name="poShipForm" id="poShipForm">
    	...
    	<tr>
    		<td colspan="2">
    			<div class="buttonBar">
					...
					<button type="button" class="btn btn-default" name="previous" onclick="window.location='miExchangeGoodsStep1.jhtml?strAction=${strAction }&newChangeKey=${newChangeKey }&shipId=${shipId }'"><fmt:message key="button.previous"/></button>    				
