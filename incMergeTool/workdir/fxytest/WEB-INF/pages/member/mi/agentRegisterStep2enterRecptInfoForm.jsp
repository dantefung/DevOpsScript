...
<div class="contentBody">
    <form:form commandName="poShip" method="post" action="agentRegisterStep2enterRecptInfo.jhtml" onsubmit="return validateForm(this)" name="poShipForm" id="poShipForm">
    ...
    <table class="detail">
    	...
    	<tr class="shipType1TR" style="display:${shipType1Display};">
    		...
    		<td><form:input path="shipMobile" id="shipMobile" onkeypress="checkNum()" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td>
    	</tr>
    	
    	<tr class="shipType1TR" style="display:${shipType1Display};">
    		<th><fmt:message key="csServiceCenter.telephone"/>:</th>
    		<td><form:input path="shipPhone" id="shipPhone" onkeypress="checkNum()" onkeyup="this.value=this.value.replace(/\D/g,'')"/></td>
    	</tr>
    		...
    		<td colspan="2">
    			<div class="buttonBar">
    				<input type="hidden" value="${form.token}" name="_form_uniq_id" />
   					<button type="button" name="previous" class="btn btn-danger" onclick="window.location='agentRegisterStep1.jhtml?newAgentRegisterKey=${newAgentRegisterKey}'"><fmt:message key="button.previous"/></button>
