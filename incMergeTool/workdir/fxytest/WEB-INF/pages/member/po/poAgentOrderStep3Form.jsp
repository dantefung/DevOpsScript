...
<form method="get" action="poAgentOrderStep3.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="poAgentOrderStep3.jhtml">
		...
		<tbody>
			<c:forEach items="${pmProducts}" var="pmProductVar">
				...
				<tr>
					...
					<td align="right"><s><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.returnPrice }"/></s></td>
					<%-- <td align="right"><s><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.returnPv }"/></s></td> --%>
					<td align="right"><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.returnPrice*discount }"/></td>
					<%-- <td align="right"><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.returnPv*discount }"/></td> --%>
					<td align="center">
						...
						<input type="hidden" name="${pmProductVar.productId }_unitPrice" id="${pmProductVar.productId }_unitPrice" value="${pmProductVar.returnPrice*discount }"/>
						<input type="hidden" name="${pmProductVar.productId }_unitPv" id="${pmProductVar.productId }_unitPv" value="${pmProductVar.returnPv*discount }"/>
		...
		<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<input type="hidden" id="newOrderKey" name="newOrderKey" value="${newOrderKey}"/>
    				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poAgentOrderStep2.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
