...
<form:form commandName="poShip" method="post" action="poActiveStep2.jhtml" onsubmit="return validateForm(this)" name="poShipForm" id="poShipForm" cssClass="form-horizontal">
		...
		<div class="col-md-7">
			...
			<div class="form-group form-group-sm">
				<div class="col-sm-12 text-center">
    				...
    				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poActiveStep1.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
