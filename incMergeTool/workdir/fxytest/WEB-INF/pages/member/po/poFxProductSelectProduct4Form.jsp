...
<form method="get" action="poFxProductSelectProduct4.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="poFxProductSelectProduct4.jhtml">
	...
	<tr>
   		<td colspan="2">
   			<div class="buttonBar">
   				...
   				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poFxProductSelectProduct.jhtml?strAction=${param.strAction }'"><fmt:message key="button.previous"/></button>
