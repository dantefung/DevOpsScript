...
<form method="get" action="poReOrderStep3.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="poReOrderStep3.jhtml">
		...
		<tbody>
			<c:forEach items="${pmProducts}" var="pmProductVar">
				...
				<tr>
					...
					<td align="right"><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.returnPrice }"/></td>
					<td align="right"><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.returnPv }"/></td>
					<td align="center">
						...
						<input type="hidden" name="${pmProductVar.productId }_unitPrice" id="${pmProductVar.productId }_unitPrice" value="${pmProductVar.returnPrice }"/>
						<input type="hidden" name="${pmProductVar.productId }_unitPv" id="${pmProductVar.productId }_unitPv" value="${pmProductVar.returnPv }"/>
		...
		<tr>
    		<td colspan="2">
    			<div class="buttonBar">
    				...
    				<input type="hidden" id="newOrderKey" name="newOrderKey" value="${newOrderKey}"/>
    				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poReOrderStep2.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
