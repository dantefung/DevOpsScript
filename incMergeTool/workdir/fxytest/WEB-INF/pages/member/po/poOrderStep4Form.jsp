...
<form method="get" action="poO2oOrderStep4.jhtml" class="form-inline">
...
<form id="pmProductListTableForm" method="post" action="poOrderStep4.jhtml">
		...
		<tbody>
			<c:forEach items="${requestScope[pmProducts]}" var="pmProductVar">
				...
				<tr>
					...
					<%-- <td align="right"><fmt:formatNumber pattern="###,##0.00" value="${pmProductVar.o2o_pv }"/></td>  --%>
					<td align="center">
	...
	<tr>
   		<td colspan="2">
   			<div class="buttonBar">
   				...
   				<button type="button" class="btn btn-default" name="previous" onclick="window.location='poOrderStep2.jhtml?strAction=${param.strAction }&newOrderKey=${newOrderKey }'"><fmt:message key="button.previous"/></button>
